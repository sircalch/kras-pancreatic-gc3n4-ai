...
KEY = 'kras'
CFG = {'color': '#00695C', 'accent': '#4527A0', 'title': 'Atomistic Screening of 2D g-C$_3$N$_4$ Nanocarriers for KRAS-G12D Inhibitor Loading', 'hero': 'figures/fig9_kras_3d_spatial_binding_modes.png', 'hero_crop': (0.0, 0.34), 'hero_cap': 'MRTX1133 in the KRAS-G12D Switch II allosteric pocket (PDB 7RPZ)', 'data': 'data/processed/MASTER_COMPOUNDS_CURATED.csv', 'mode': 'xy', 'x': 'Real_Vina_Score_kcal_mol', 'y': 'Delta_E_ads_Pristine_kcal_mol', 'panel_title': 'Target binding vs. carrier loading (n = 33)', 'xlab': 'AutoDock Vina on KRAS-G12D 7RPZ (kcal/mol)', 'ylab': 'ΔE$_{ads}$ on pristine g-C$_3$N$_4$ (kcal/mol)', 'takeaway': 'Crystallographic self-redocking on the 1.30 Å KRAS-G12D structure (PDB 7RPZ) reproduces the native MRTX1133 pose to 1.4 Å RMSD. Drugs adsorb on g-C$_3$N$_4$ at −5 to −39 kcal/mol (B/P-doping shifts this only slightly); the descriptor QSPR is an exploratory ranking only.'}
